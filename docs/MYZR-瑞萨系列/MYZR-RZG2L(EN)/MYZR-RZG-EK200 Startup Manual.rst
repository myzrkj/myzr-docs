...
|  [DEBUG Serial Port Connector]: 1 piece
...
.. figure:: /image/MYZR-瑞萨系列/MYZR-RZG2L/1425px-Myzr_rzg2l_zheng.jpg
   :alt: 1425px-Myzr_rzg2l_zheng.jpg

**MYZR-RZG2UL-MB200-ETH**

.. figure:: /image/MYZR-瑞萨系列/MYZR-RZG2L/1425px-Myzr_rzg2ul-eth_zheng.jpg
   :alt: 1425px-Myzr_rzg2ul-eth_zheng.jpg

**MYZR-RZG2UL-MB200-LCD**

.. figure:: /image/MYZR-瑞萨系列/MYZR-RZG2L/1425px-Myzr_rzg2ul-lcd_zheng.jpg
...
|  Connect the Debug serial port connector to the Debug_232 interface, then use a USB-to-serial cable to connect the computer's serial port and the Debug serial port connector.
|  Refer to the :doc:`《Terminal Software XShell Reference Manual》 </docs/COMMON/Xshell.RM.参考手册>` to create a new serial session and open the session.
...
|  Set the DIP switch SW: BOOT of the development board to the normal boot mode. The DIP switch modes are as follows:
|  [EMMC Boot]: 1 (off), 2 (off), 3 (on), 4 (off)
...
|  Directly connect the power adapter to power on the development board, and turn on the power switch.

Interpretation of Development Board Boot Information
-------------------------------------------------------

|  After the development board is powered on, the boot information output by the development board can be viewed on the serial terminal software.
...
|  The boot information "Linux version 5.10.131-cip13-yocto-standard (kuangwh@myzr-7a9b) (aarch64-poky-linux-gcc (GCC) 8.3.0, GNU ld (GNU Binutils) 2.31.1) #1 SMP PREEMPT Tue Feb 7 11:45:39 CST 2023" includes the following information:
|  [Kernel Version]: 5.10.131;
|  [Hostname]: (kuangwh@myzr-7a9b)
