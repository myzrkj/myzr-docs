...
|  测试手册：:doc:`《Linux-3.10.65》<MYZR-A40I-EK204 Linux-3.10.65 测试手册>`
|  开发环境指导手册：:doc:`《Ubuntu14.04+Win10》</docs/COMMON/MYZR Windows-10 VirtualBox-5.2.12 Ubuntu-14.04.5 64位开发环境指导>`
|  编译手册：
  :doc:`《Linux-3.10.65》<MYZR-A40I-EK204 Linux-3.10.65 编译参考手册>`
  :doc:`《android》<MYZR-A40I-EK204 android 编译参考手册>`
...
2. 终端软件安装好之后，打开 :doc:`《启动手册》<MYZR-A40I-CB204 启动手册>`，参照文档启动开发板。
3. 开发板启动成功后，参照 :doc:`《linux-3.10.65烧录指导手册》<MYZR-A40I-CB204 烧录手册>` 进行一次烧录。目的是熟悉烧录操作以及准备下一步的功能验证。
...
1. 首先，硬件工程师有必要了解我们开发板底板的介绍和基本原理，具体见 :doc:`《底板硬件介绍》<MYZR-A40I-MB204 硬件介绍>` 。
2. 硬件工程师打开网盘，下载硬件原理图文件进行参考，或基于我们的原理图进行设计。
3. 如果某些接口和功能需要变更，可以参考 :doc:`《核心板硬件介绍》<MYZR-A40I-CB204 硬件介绍>` 里的 **管脚定义&详细功能说明**。
