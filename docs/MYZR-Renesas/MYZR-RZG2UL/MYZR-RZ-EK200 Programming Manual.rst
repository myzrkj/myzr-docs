...
| There are multiple programming methods, and different images correspond to different programming methods. This document will introduce a variety of image programming methods, and users can choose one or more methods to update the image according to the project conditions of development.
...
**TF card programming can be used to update the kernel, device tree, and file system. This method enables comprehensive image update and simple subsequent operations, and is used for programming in the production stage.**

| Requirements for TF card: Ensure that the TF card has one Partition 1, and the memory of Partition 1 is larger than the total memory of all programming images.
...
| After waiting for the programming to complete, the message "sdcard update succeed!!!" will be displayed. Restart the board to complete the update.
