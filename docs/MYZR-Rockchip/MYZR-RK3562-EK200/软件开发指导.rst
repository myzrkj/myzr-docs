...
1. 下载rk3562源码包，路径为：3.软件资料-->3.1源码-->rk3562-linux.tar.xz
2. 创建编译目录:
...
1. 网盘目录下，下载源码包 MYZR-RK3562_Android13_20260407.tar.bz2(请将网盘内分卷文件下载后合并可以得到该压缩包) 
2. 创建编译目录：
...
4. 成功编译后在rockdev/Image-rk3562_t/目录下可看到相关镜像，其中update.img是所有镜像的集合。
