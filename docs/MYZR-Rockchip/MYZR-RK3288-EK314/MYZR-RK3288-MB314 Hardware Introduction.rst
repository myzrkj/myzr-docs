MYZR-RK3288-MB314 Hardware Introduction
==========================================
...
+------------+----------------------+---------------------------------+
| Silkscreen |       Function       |      Interface attributes       |
+============+======================+=================================+
| P4         | Debug serial port    | 3 Line standard RS232 interface |
+------------+----------------------+---------------------------------+
| P3         | Function serial port | 3 Line standard RS232 interface |
+------------+----------------------+---------------------------------+
...
|  Silk screen：J19
|  Interface property：MIPI-CSI Camera interface
|  Definition of pin & signal：
...
+=======+==========+=====================+========+========+================+
| U19-1 | JTAG_TCK | TCK input           | U19-2  | GND    | Digital ground |
+-------+----------+---------------------+--------+--------+----------------+
| U19-3 | JTAG_TDO | Test data output    | U19-4  | VCC    | 3.3V input     |
+-------+----------+---------------------+--------+--------+----------------+
| U19-5 | JTAG_TMS | Test mode selection | U19-6  | nRST   | reset          |
+-------+----------+---------------------+--------+--------+----------------+
| U19-7 | NC       | Unconnected         | U19-8  | NC     | Unconnected    |
+-------+----------+---------------------+--------+--------+----------------+
| U19-9 | JTAG_TDI | Test mode selection | U19-10 | GND    | Digital ground |
+-------+----------+---------------------+--------+--------+----------------+
...
|  Silk screen:U14
|  Interface property: RTC button battery interface
|  For details on the pin function definition,refer to :doc:`./MYZR-RK3288-CB314 Hardware Introduction`
