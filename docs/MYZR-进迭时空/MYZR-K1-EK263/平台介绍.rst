...
|  SpacemiT Key Stone® K1是一款高性能、超低功耗的SoC，集成了8个RISC-V CPU核心和SpacemiT® Daoyi™ AI计算能力。它具备以下最重要的优势：

 - 与SpacemiT®自创新的X60™ RISC-V核心处理器集成，该处理器遵循RISC-V 64GCVB架构和RVA22标准
 - 能够通过利用定制的RISC-V指令实现2.0 TOPS的AI计算能力，实现CPU人工智能融合计算
 - 支持流行的人工智能推理框架，如 TensorFlow Lite、TensorFlow 和 ONNX Runtime
 - 通过采用多粒粒级功率岛和动态功率状态调整实现超低功耗，使K1在能效方面具有高度竞争力
 - 提供支持创新应用和产品的全功能接口
 - 兼容主流作系统以满足各种应用场景的需求
 - 符合工业级可靠性标准
...
~~~~~~~~~~~~
  ...
  - Dual-Chip selection, 32-bit LPDDR4/LPDDR4x SDRAM with 2666 Mbps transfer rate, supporting up to 16GB of RAM
...
-  应用于工业网关、机器人、鸿蒙平板等领域，支持3D空间计算、语音识别等复杂任务
