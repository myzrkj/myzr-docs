...
　　u-boot-nodtb.bin, spl/u-boot-spl.bin, arch/arm/dts/myimx8mmek200.dtb 即目标文件，在下一步骤编译 Boot 文件时会依赖这些文件。
...
　　iMX8M/boot-myimx8mmek200.bin 即目标文件，可以用编译出来的目标文件替换烧录工具的同名文件。  
