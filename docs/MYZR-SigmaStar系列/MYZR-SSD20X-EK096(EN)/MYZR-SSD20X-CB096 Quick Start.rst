MYZR-SSD20X-CB096 Quick Start
===============================

The connection of the serial port line
-----------------------------------------
...
|  Connect one end of the power adapter to the "5V_IN" of the development board, and plug the other end into the mains (220V AC) socket.

Startup information for the board
-----------------------------------
...
|  After starting the system and outputting "myzr login:", you can log in:

 | 【Username】：root
 | 【Password】：none

|  Note: You can set and change the password by using the "passwd" command after logging in.