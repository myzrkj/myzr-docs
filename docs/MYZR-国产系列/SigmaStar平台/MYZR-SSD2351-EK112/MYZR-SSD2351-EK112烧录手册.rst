...
.. image:: /image/MYZR-国产系列/SigmaStar平台/MYZR-SSD2351/烧录手册01.png
   :alt: 烧录手册01.png
...
.. image:: /image/MYZR-国产系列/SigmaStar平台/MYZR-SSD2351/烧录手册02.png
   :alt: 烧录手册02.png
...
|  烧写工具：FlashTool_5.0.52.tar.gz
|  本方式适用于空片烧录或者板子无法进入Uboot控制台的情况下使用。
|  如非空片或者能够正常启动的情况下，想使用Flash Tool烧录，则需要按照以下方式先关闭掉Debug Uart

- uboot控制台下直接输入`debug`，然后关闭串口终端

.. image:: /image/MYZR-国产系列/SigmaStar平台/MYZR-SSD2351/烧录手册03.png
   :alt: 烧录手册03.png

- kernel下，则输入`11111`，然后关闭串口终端

.. image:: /image/MYZR-国产系列/SigmaStar平台/MYZR-SSD2351/烧录手册04.png
   :alt: 烧录手册04.png
...
.. image:: /image/MYZR-国产系列/SigmaStar平台/MYZR-SSD2351/烧录手册05.png
   :alt: 烧录手册05.png

|  烧写boot.bin镜像

.. image:: /image/MYZR-国产系列/SigmaStar平台/MYZR-SSD2351/烧录手册06.png
   :alt: 烧录手册06.png
...
.. image:: /image/MYZR-国产系列/SigmaStar平台/MYZR-SSD2351/烧录手册07.png
   :alt: 烧录手册07.png
