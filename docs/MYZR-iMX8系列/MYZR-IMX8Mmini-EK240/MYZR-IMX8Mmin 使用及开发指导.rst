...
| **测试手册：** :doc:`《Linux-4.14.98》 <./MYZR-IMX8MM-EK240-8MM Linux-4.14.98 测试手册>`
| **开发环境指导手册：**
...
| **编译手册：** 
 :doc:`《Linux-4.14.98》 <./MYZR-IMX8MM-EK240-8MM Linux-4.14.98 编译参考手册>`,
 :doc:`《android9.0》 <./MYZR-I.MX8Mmini-CB240 ANDROID9.1 烧录手册>`
...
2. 终端软件安装好之后，打开 :doc:`《启动手册》 <./MYZR-I.MX8Mmini-CB240 启动手册>` ，参照文档启动开发板。
3. 开发板启动成功后，参照 :doc:`《linux-4.14.98烧录指导手册》 <./MYZR-I.MX8Mmini-CB240 烧录手册>` 、 :doc:`《ANDROID9.0烧录指导手册》 <./MYZR-I.MX8Mmini-CB240 ANDROID9.1 烧录手册>` 进行一次烧录。目的是熟悉烧录操作以及准备下一步的功能验证。
...
1. 首先，硬件工程师有必要了解我们开发板底板的介绍和基本原理，具体见 :doc:`《底板硬件介绍》 <./MYZR-I.MX8Mmini 硬件介绍>` 。
2. 硬件工程师打开网盘，下载硬件原理图文件进行参考，或基于我们的原理图进行设计。
3. 如果某些接口和功能需要变更，可以参考 :doc:`《核心板硬件介绍》 <./MYZR-I.MX8Mmini-CB240 硬件介绍>` 里的 **管脚定义&详细功能说明** 。更多详细信息请参照网盘中的"1.1_NXP-Document ->I.MX8M-> IMX8MDQLQRM_Rev0.pdf"
