MYZR-IMX6-EK336 Linux-3.14.52 测试手册 v2.0
=============================================
...
.. code:: shell
    ...
    root@myimx6ek336:~# g_mass_storage gadget: high-speed config #1: Linux File-Backed Storage
...
.. code:: shell
    ...
    root@myimx6ek336:~# IPv6: ADDRCONF(NETDEV_UP): usb0: link is not ready
...
.. code:: shell
    ...
    Filename 'myimx6ek336-6q-1g.dtb'.
    Load address: 0x12000000
    Loading: ###
             885.7 KiB/s
    done
    Bytes transferred = 43574 (aa36 hex)
    writing myimx6ek336-6q-1g.dtb
    43574 bytes written
...
.. code:: shell
    ...
    Using FEC device
    TFTP from server 192.168.137.99; our IP address is 192.168.137.9
    Filename 'uboot-myimx6ek336-6q-1g.imx'.
    Load address: 0x12000000
    Loading: ###########################
             3 MiB/s
    done
...
.. code:: shell
    ...
    tftp -g 192.168.137.99 -r myimx6ek336-6q-1g.dtb
...
.. code:: shell
    ...
    =====> 输出信息：
    my_environment.scr  myimx6ek336-6q-1g.dtb  zImage-myimx6a9

**系统自动挂载分区**

|   复制相应的文件到/run/media/mmcblk3p1/目录，将原文件替换。

.. code:: shell

    =====> 输入指令:
    cp zImage-myimx6a9 /run/media/mmcblk3p1/
    cp myimx6ek336-6q-1g.dtb /run/media/mmcblk3p1/
