...
|   测试手册：
  :doc:`《Linux-3.14.52》 <./MYZR-IMX6-EK336 Linux-3.14.52 测试手册 v2.0>`,
  :doc:`《Linux-4.1.15》 <./MYZR-IMX6-EK336 Linux-4.1.15 测试手册 v2.0>`
...
2. 终端软件安装好之后，打开 :doc:`《启动手册》 <./MYZR-IMX6-EK336启动手册>` ，参照文档启动开发板。
...
3. 如果某些接口和功能需要变更，可以参考 :doc:`《核心板硬件介绍》 <./MYZR-IMX6-CB336 硬件介绍>` 里的 **管脚定义&详细功能说明** 。更多详细信息请参照网盘中的"1.1_NXP-Document -> reference-manual"
