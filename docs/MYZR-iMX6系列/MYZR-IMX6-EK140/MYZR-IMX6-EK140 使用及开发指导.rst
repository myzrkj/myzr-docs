...
| **测试手册**：:doc:`《Linux-4.1.15》<MYZR-IMX6-EK140 Linux-4.1.15 测试手册>`
| **开发环境指导手册**：
...
| **驱动和设备手册**：
  :doc:`《Linux-4.1.15》<MYZR-IMX6-EK140 L40115 驱动和设备>`
  :doc:`《Linux-4.9.88》<MYZR-IMX6-EK140 L40988 驱动和设备>`
...
2. 终端软件安装好之后，打开 :doc:`《启动手册》<MYZR-IMX6-EK140 启动手册>` ，参照文档启动开发板。
...
1. 首先，硬件工程师有必要了解我们开发板底板的介绍和基本原理，具体见 :doc:`《底板硬件介绍》<MYZR-IMX6-MB140-MINI 硬件介绍>` 。
2. 硬件工程师打开网盘，下载硬件原理图文件进行参考，或基于我们的原理图进行设计。
3. 如果某些接口和功能需要变更，可以参考 :doc:`《核心板硬件介绍》<MYZR-IMX6-CB140 硬件介绍>` 里的 管脚定义&详细功能说明。更多详细信息请参照网盘中的"1.1_NXP-Document -> reference-manual"
