MYZR-IMX6-EK140 Use and Development Guidance
===============================================
...
| **Test Manual**：
  :doc:`《Linux-4.1.15》<MYZR-IMX6-EK140 Linux-4.1.15 Test Manual>`
...
2. After the installation of terminal software, open :doc:`《Quick Start》<MYZR-IMX6-EK140 Quick Start>`, refer to the document to start the development board.
...
1. First of all, it is necessary for hardware engineers to understand the introduction and basic principles of our development board floor. See :doc:`《Base Plate Introduction》<MYZR-IMX6-MB140-MINI Hardware Introduction>` 。
