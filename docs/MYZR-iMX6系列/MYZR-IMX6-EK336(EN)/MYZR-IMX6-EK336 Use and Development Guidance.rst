MYZR-IMX6-EK336 Use and Development Guidance
==============================================
...
|   Test Manual：
  :doc:`《Linux-3.14.52》 <./MYZR-IMX6-EK336 Linux-3.14.52 Test Manual v2.0>`,
...
1. 1. After getting the development board, the first thing is to prepare for the use of the development board, installation of terminal software is necessary.Open :doc:`《Terminal Software Reference Manual》 </docs/COMMON/Xshell.RM.参考手册>` , refer to Software Download and Installation to install the terminal software.
2. After the installation of terminal software, open :doc:`《Quick Start》 <./MYZR-IMX6-EK336 Quick Start>`  , refer to the document to start the development board.
...
1. 1. First of all, it is necessary for hardware engineers to understand the introduction and basic principles of our development board floor. See :doc:`《Base Plate Introduction》 <./MYZR-IMX6-MB314 Hardware Introduction>` for details.。
...
3. 3. If some interfaces and functions need to be changed, please refer to the Pin definition & detailed function description in :doc:`《Core board introduction》 <./MYZR-IMX6-CB336 Hardware Introduction>` Refer to "1.1 _nxp-document-> reference-manual" in the network disk for more details.
