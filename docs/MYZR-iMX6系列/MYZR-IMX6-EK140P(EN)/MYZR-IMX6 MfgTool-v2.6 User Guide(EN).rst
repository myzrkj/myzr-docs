...
|  MYZR-IMX6-EK140、MYZR-IMX6-EK140P download **MYZR-IMX-A7** Directory.
|  MYZR-IMX6-EK200、MYZR-IMX6-EK314、MYZR-IMX6-EK3336 Download **MYZR-IMX-A9** directory.

2. Unpack the downloaded file **to the current folder**.

.. figure:: /image/MYZR-iMX6系列/MYZR-IMX6-EK140/MY_WinRAR_Extract.png
...
2. 2. Connect the development board and computer with a serial port line, refer to :doc:`《Terminal Software Reference Manual》 </docs/COMMON/Terminal software XShell reference manual>` In **connection to session** Open serial session.
3. 3. Connect the power cord for the development board and then power it.

**Burn system to development board**

1. To avoid unnecessary errors, close the burn tool main program ** MfgTools 2. EXE ** and rerun.

.. figure:: /image/MYZR-iMX6系列/MYZR-IMX6-EK140/MY_IMX6_MfgTool_3.3.0.1.jpg
...
.. figure:: /image/MYZR-iMX6系列/MYZR-IMX6-EK140/MY_IMX6_MfgTool_3.5.0.1.jpg
...
.. figure:: /image/MYZR-iMX6系列/MYZR-IMX6-EK140/MY_IMX6_MfgTool_3.5.0.2.jpg
...
.. figure:: /image/MYZR-iMX6系列/MYZR-IMX6-EK140/MY_IMX6_MfgTool_3.5.0.3.jpg
...
+-----------------+----------------------------+------------------------------+--------------------------------------------------------------+
| System Version  | File Type                  | Locate directory             | 对应的文件                                                   |
+-----------------+----------------------------+------------------------------+--------------------------------------------------------------+
...
+                 +----------------------------+                              +--------------------------------------------------------------+
|                 | Kernel module package      |                              | image-L4.9.88-kernel/kernel-modules-myimx6[a7 / a9].tar.bz2  |
+                 +----------------------------+                              +--------------------------------------------------------------+
|                 | Device Tree File           |                              | image-L4.9.88-dtb/<ek_name>-<ek_spec>.dtb                    |
+                 +----------------------------+                              +--------------------------------------------------------------+
|                 | File System Update Package |                              | image-L4.9.88-update/L4988-rootfs-update.tar.bz2             |
+                 +----------------------------+                              +--------------------------------------------------------------+
