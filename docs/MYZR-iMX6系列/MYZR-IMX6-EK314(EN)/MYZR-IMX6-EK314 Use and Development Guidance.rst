MYZR-IMX6-EK314 Use and Development Guidance
===============================================
...
|   Test Manual：
  :doc:`《Linux-4.1.15》 <./MYZR-IMX6-EK314 Linux-4.1.15 Test Manual v2.0>`,
  :doc:`《Linux-3.14.52》 <./MYZR-IMX6-EK314 Linux-3.14.52 Test manual v2.0>`,
...
1. First of all, it is necessary for hardware engineers to understand the introduction and basic principles of our development board floor. See :doc:`《Base Plate Introduction》 <./MYZR-IMX6-MB314 Hardware Introduction>` for details.
...
3. If some interfaces and functions need to be changed, please refer to the Pin definition & detailed function description in :doc:`《Core board introduction》 <./MYZR-IMX6-CB314 Hardware Introduction>` 里的 **管脚定义&详细功能说明** .Refer to "1.1 _nxp-document-> reference-manual" in the network disk for more details.
