...
| 接口规格               | 最大可配置接口数 | 描述                                                                        |
+============+===========+==================+=============================================================================+
| 通讯接口   | Ethernet  | 1                | 1 路以太网控制器，支持 RGMII/RMII，速率 10/100/1000Mbps                     |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | USB2.0    | 2                | 1 路 USB2.0 Host、1 路 USB2.0 OTG，最高传输速率 480Mbps。                   |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | USB3.0    | 1                | 1路USB 3.0 Host (Type-A) ,最高传输速率 5Gbps                                |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | UART      | 6                | 6 路 UART 接口，最高波特率 4Mbps，除 UART2 外其余支持硬件流控               |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | SPI       | 3                | 2 路通用 SPI+1 路专用 FSPI，每路支持主从模式，FSPI 兼容 1/2/4 线传输        |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | I2C       | 6                | 6 路 I2C 接口，支持 7bit/10bit 地址，最高速率 1Mbps。                       |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | CAN       | 1                | 1 路 CAN 接口，支持标准帧、扩展帧及 CAN FD。                                |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | PWM       | 13               | 内置12 路通用 PWM加1路音频专用 PWM                                          |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | ADC       | 8                | 6 路 10 位 SARADC与2 路温度检测 TSADC，SARADC 最高采样率 1MS/s。            |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | I2S       | 3                | 3 路 I2S 音频接口，最高 192KHz 采样率                                       |
+------------+-----------+------------------+-----------------------------------------------------------------------------+
| 外部存储   | SDIO      | 1                | 1 路 SDIO3.0 接口，支持SD3.0,MMC4.51                                        |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | eMMC      | 1                | 1 路 eMMC 4.51 接口，支持 1/4/8bit 总线，HS200 模式                         |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | FSPI      | 1                | 1 路 FSPI 接口，支持 x1/x2/x4 四线模式，2 路片选，兼容 SPI Flash            |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | NAND Flash| 1                | 1 路异步 NAND Flash 接口，8bit 数据总线，硬件 ECC（最大 16bits/1KB）        |
+------------+-----------+------------------+-----------------------------------------------------------------------------+
| 多媒体     | CSI_MIPI  | 2                | 2 路 MIPI CSI 图像输入接口，单路最高 4 通道，最大分辨率 4416×3312@30fps     |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | DSI_MIPI  | 1                | 支持 1 路 4Lane的DSI_MIPI 接口，最大分辨率 1920×1080@60fps                  |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | LVDS      | 2                | 2路4通道LVDS 视频输入接口，与 MIPI CSI 引脚复用，最大分辨率 4416×3312@30fps |
+            +-----------+------------------+-----------------------------------------------------------------------------+
|            | RGB       | 1                | 1 路 24bit 并行 RGB 显示接口，最高分辨率1920×1080 @ 60fps                   |
+------------+-----------+------------------+-----------------------------------------------------------------------------+
| 内核版本   |                               6.1.141                                                                      |
+------------+-----------+------------------+-----------------------------------------------------------------------------+
| 文件系统   |                               Buildroot/Debian12                                                           |
+------------+-----------+------------------+-----------------------------------------------------------------------------+
| 界   面    |                              QT/LVGL                                                                       |
+------------+-----------+------------------+-----------------------------------------------------------------------------+
