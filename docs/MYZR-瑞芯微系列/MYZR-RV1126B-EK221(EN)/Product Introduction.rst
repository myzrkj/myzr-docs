...
+------------------+------------+------------------------+---------------------------------------------------------------------------------------------+
| Interface Type                | Max Configurable Ports | Description                                                                                 |
+==================+============+========================+=============================================================================================+
| Communication    | Ethernet   | 1                      | 1 Ethernet controller, supports RGMII/RMII, rate 10/100/1000Mbps                            |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | USB2.0     | 2                      | 1 USB2.0 Host, 1 USB2.0 OTG, max transfer rate 480Mbps.                                     |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | USB3.0     | 1                      | 1 USB 3.0 Host (Type-A), max transfer rate 5Gbps                                            |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | UART       | 6                      | 6 UART interfaces, max baud rate 4Mbps. Except UART2, others support hardware flow control. |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | SPI        | 3                      | 2 general SPI + 1 dedicated FSPI. Each supports master/slave mode; FSPI supports 1/2/4-wire.|
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | I2C        | 6                      | 6 I2C interfaces, supports 7bit/10bit address, max rate 1Mbps.                              |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | CAN        | 1                      | 1 CAN interface, supports standard frame, extended frame and CAN FD.                        |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | PWM        | 13                     | Built-in 12 general PWM + 1 audio dedicated PWM.                                            |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | ADC        | 8                      | 6-channel 10-bit SARADC + 2 temperature TSADC. Max SARADC sampling rate 1MS/s.              |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | I2S        | 3                      | 3 I2S audio interfaces, max sampling rate 192KHz.                                           |
+------------------+------------+------------------------+---------------------------------------------------------------------------------------------+
| External Storage | SDIO       | 1                      | 1 SDIO3.0 interface, supports SD3.0, MMC4.51.                                               |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | eMMC       | 1                      | 1 eMMC 4.51 interface, supports 1/4/8bit bus, HS200 mode.                                   |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | FSPI       | 1                      | 1 FSPI interface, supports x1/x2/x4 mode, 2 chip selects, compatible with SPI Flash.        |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | NAND Flash | 1                      | 1 asynchronous NAND Flash interface, 8-bit data bus, hardware ECC (max 16bits/1KB).         |
+------------------+------------+------------------------+---------------------------------------------------------------------------------------------+
| Multimedia       | CSI_MIPI   | 2                      | 2 MIPI CSI input, max 4 lanes per channel, max resolution 4416×3312@30fps.                  |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | DSI_MIPI   | 1                      | 1 4-Lane DSI_MIPI interface, max resolution 1920×1080@60fps.                                |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | LVDS       | 2                      | 2 4-channel LVDS video interface, pin shared with MIPI CSI, max 4416×3312@30fps.            |
+                  +------------+------------------------+---------------------------------------------------------------------------------------------+
|                  | RGB        | 1                      | 1 24-bit parallel RGB display, max resolution 1920×1080 @ 60fps.                            |
+------------------+------------+------------------------+---------------------------------------------------------------------------------------------+
| Kernel Version   |                                       6.1.141                                                                                     |
+------------------+------------+------------------------+---------------------------------------------------------------------------------------------+
| File System      |                                       Buildroot/Debian12                                                                          |
+------------------+------------+------------------------+---------------------------------------------------------------------------------------------+
| GUI Framework    |                                       QT/LVGL                                                                                     |
+------------------+------------+------------------------+---------------------------------------------------------------------------------------------+
