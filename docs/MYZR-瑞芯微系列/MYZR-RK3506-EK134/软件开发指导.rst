...
|   内核板级设备树文件：kernel-6.1/arch/arm/boot/dts/rockchip/myzr-rk3506-ek200.dts
...
|   RK3506的GPIO分为4组（GPIO0~GPIO3），每组又以 A0~A7, B0~B7, C0~C7, D0~D7 作为编号区分。例如
...
1. 设备树配置（UART3_M0为例，在J17扩展接口上对应5和6引脚）
