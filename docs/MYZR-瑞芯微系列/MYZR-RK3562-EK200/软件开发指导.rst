...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/安装虚拟机软件.png
   :alt: 安装虚拟机软件
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/3.png
   :alt: 安装虚拟机软件03
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/安装虚拟机软件_05.png
   :alt: 安装虚拟机软件_05
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/添加Windows网卡.jpeg
   :alt: 添加Windows网卡
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/添加Windows网卡_06.jpeg
   :alt: 添加Windows网卡_06
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/配置Windows网卡.jpeg
   :alt: 配置Windows网卡
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/配置Windows网卡_02.jpeg
   :alt: 配置Windows网卡_02
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/配置Windows网卡_03.jpeg
   :alt: 配置Windows网卡_03
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/配置Windows网卡_04.jpeg
   :alt: 配置Windows网卡_04
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/导入虚拟机系统.png
   :alt: 导入虚拟机系统
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/导入虚拟机系统_03.png
   :alt: 导入虚拟机系统_03
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/导入虚拟机系统_05.png
   :alt: 导入虚拟机系统_05
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_02.png
   :alt: 虚拟机设置_02
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_06.png
   :alt: 虚拟机设置_06
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_07.png
   :alt: 虚拟机设置_07
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_08.png
   :alt: 虚拟机设置_08
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_11.png
   :alt: 虚拟机设置_11
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_12.png
   :alt: 虚拟机设置_12
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_16.png
   :alt: 虚拟机设置_16
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机设置_17.png
   :alt: 虚拟机设置_17
   :width: 100%
...
.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_03.png
   :alt: 虚拟机与PC互传文件_03
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_04.png
   :alt: 虚拟机与PC互传文件_04
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_05.png
   :alt: 虚拟机与PC互传文件_05
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_06.png
   :alt: 虚拟机与PC互传文件_06
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_07.png
   :alt: 虚拟机与PC互传文件_07
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_08.png
   :alt: 虚拟机与PC互传文件_08
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_09.png
   :alt: 虚拟机与PC互传文件_09
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_10.png
   :alt: 虚拟机与PC互传文件_10
   :width: 100%

.. image:: ../../../image/MYZR-瑞芯微系列/MYZR-RK3562-EK200/虚拟机与PC互传文件_11.png
   :alt: 虚拟机与PC互传文件_11
   :width: 100%
...
1.下载rk3562源码包，路径为：3.软件资料-->3.1源码-->Linux-->myzr-rk3562.tar.gz.part_a*
...
首次编译需要加载SDK配置文件，进入rk3562_sdk目录，输入如下命令加载配置文件：
...
1.回到SDK主目录，运行整体编译(编译时间较长)，输入如下命令:

.. code-block:: shell

   #1.选择 myzr_rk3562_defconfig 板级⽂件
...
1.在SDK下的output/update/Image⽬录将镜像打包成update.img
...
u-boot 板级文件位置：u-boot/board/rockchip/myzr_rk3562

u-boot 板级配置文件：include/configs/myzr_rk3562.h

u-boot 板级编译配置文件：configs/myzr_rk3562_defconfig

Linux内核板级文件
~~~~~~~~~~~~~~~~~

内核板级编译配置文件：kernel-5.10/arch/arm64/configs/rockchip_linux_defconfig

内核板级设备树文件：

1.kernel-5.10/arch/arm64/boot/dts/rockchip/myzr-rk3562-ek200.dts（默认设备树，适用于hdmi显示屏）

2.kernel-5.10/arch/arm64/boot/dts/rockchip/myzr-rk3562-ek200-lvds-lcd.dtsi（备用，适用于lvds lcd显示屏）

3.kernel-5.10/arch/arm64/boot/dts/rockchip/myzr-rk3562-ek200-mipi-lcd.dtsi（备用，适用于mipi lcd显示屏）

Ethernet
~~~~~~~~

开发板有俩个网口：CON8、CON9，以CON8说明，CON9同理
...
等待或者电脑网络适配器能上网的网口关掉共享给以太网网口并重新开启共享，再重启板⼦便能⾃动获取ip。
...
RK3562的GPIO分为5组（GPIO0~GPIO4），每组又以 A0~A7, B0~B7, C0~C7, D0~D7 作为编号区分。例如：
...
在RK3562平台上，PWM硬件驱动通过计数器与比较器协同工作：APB总线时钟源经分频器调整后驱动计数器周期性递增/递减，达到预设周期值后自动复位生成基础信号；比较器实时比对计数器值与占空比阈值，输出高低电平，并通过极性控制位切换normal（高有效）或inversed（低有效）模式。用户层通过/sys/class/pwm接口或内核API（如pwm_config）控制，核心层由pwm_chip管理控制器资源并注册接口，底层硬件适配层需实现pwm_ops操作集（含config、enable等函数），直接操作PWM寄存器完成频率、占空比及使能配置。

2.PWM设备树配置
^^^^^^^^^^^^^^^

以PWM14_M0为例，在rk3562.dtsi文件中配置时钟及管脚：
...
在myzr-rk3562-ek200-lvds-lcd.dtsi中添加节点
...
在需要使用PWM的设备节点（如背光等）中引用PWM控制器并设置参数（若无需使用设备，可以不做配置）。以下是通用配置示例：
...
PWM参数传递：pwms = <&pwm14 0 10000000 1> 绑定pwm14控制器的0号通道，设置周期为10ms（10000000ns，对应100Hz频率），极性为1（高电平有效）duty_ns = 5000000 指定初始占空比为5ms（50%占空比），驱动通过pwm_config()写入硬件寄存器。
...
RK3562的PWM控制器命名为pwmchip*，需根据设备树中&pwm14的地址确认具体编号。这里假设pwm14对应pwmchip3。
...
在 RK3562 平台中，I2C 控制器基于标准 Linux I2C 框架实现，其核心分为硬件抽象层（适配器驱动）和设备驱动层。硬件层通过 i2c_adapter 抽象 I2C 总线控制器，设备层通过 i2c_client 描述从机设备，两者通过 i2c_driver 实现驱动逻辑。RK3562 的 I2C 控制器支持多主模式、时钟分频（最高 400kHz）及中断/DMA 传输，其物理层遵循开漏输出特性，通过 GPIO 复用实现 SCL/SDA 信号。

2.I2C设备树配置（以I2C1上挂载gt911触摸芯片为例）
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

打开myzr-rk3562-ek200-lvds-lcd.dts进行配置
...
内核在启动时解析此节点，调用drivers/spi/spi-rockchip.c 中的驱动代码初始化 SPI0 控制器，注册为 /sys/bus/spi/devices/spi0.0。SPI设备通过片选信号（Chip Select, CS）寻址，#address-cells=1 表示 reg 属性对应 CS 编号（如 reg=<0> 表示使用 SPI0 的 CS0 线），在生成 SPI 设备时，内核根据 reg 值控制对应的 GPIO 引脚输出低电平以激活目标设备。

在compatible=”spidev”匹配成功后，将触发内核加载 drivers/spi/spidev.c，创建设备节点 /dev/spidev0.0。用户态程序无需开发内核驱动，可直接通过 ioctl(SPI_IOC_MESSAGE) 或 write() 等系统调用发起 SPI 数据传输请求。该请求经 spidev 驱动接收后，内核会通过 spi_async() 接口将数据传输任务提交至 SPI 控制器驱动（如 SPI0 控制器），最终由硬件控制器根据配置的时钟极性、速率等参数生成 SCK 信号，通过 MOSI 引脚发送数据流，并同步从 MISO 引脚读取响应数据，完成全双工通信过程。

3.调试工具
^^^^^^^^^^

短接SPI0_M0的mosi和miso，运行文件系统中的spi测试程序
...
pinctrl-0 = <&uart6m0_xfer>的作用，绑定UART6的TX/RX引脚到uart6m0_xfer复用组。

uart6m0_xfer在rk3562-pinctrl.dtsi中已定义：
...
设备树配置好之后，UART6在系统中注册为/dev/ttyS6，可通过ls /dev/ttyS*验证。

2.调试工具
^^^^^^^^^^

将uart6m0的rx tx短接，利用文件系统/test_app内放置的测试文件进行收发测试：
