...
MYZR-IMX6-EK200 Use and Development Guidance
===============================================
...
| **Test Manual**：
  :doc:`《Linux-3.14.52》 <./MYZR-IMX6-EK200 Linux-3.14.52 Test Manual v2.0>`,
  :doc:`《Linux-4.1.15》 <./MYZR-IMX6-EK200 Linux-4.1.15 Test Manual v2.0>`,
  :doc:`《Linux-3.0.35》 <./MYZR-IMX6-EK200 Linux-3.0.35 Test Manual>`,
...
| **Build Manual**：
  ...
  :doc:`《Linux-3.0.35》 <./MYZR-IMX6-A9 Linux-3.0.35 v3.0>`,
  :doc:`《Android-5.1.1》 <./MYZR-IMX6 Android-5.1.1 Build Manual>`,
  :doc:`《Android-4.4.2》 <./MYZR-IMX6 Android-4.4.2 Build Manual>`,
  :doc:`《Android-4.2.2》 <./MYZR-IMX6 Android-4.2.2 Build Manual>`
...
1. After getting the development board, the first thing is to prepare for the use of the development board, installation of terminal software is necessary.Open :doc:`《Xshell.RM Reference Manual 》 </docs/COMMON/Xshell.RM Reference Manual >` ，refer to **Software Download and Installation** to install the terminal software.
2. After the installation of terminal software, open :doc:`《Quick Start》 <./MYZR-IMX6-EK200 Quick Start>` or :doc:`《Android-4.2.2 Quick Start》 <./MYZR-IMX6-EK200 Android-4.2.2 Quick Start>` ，refer to the document to start the development board.
3. After the development board is started successfully, refer to :doc:`《Burning Manual》 <./MYZR-IMX6 MfgTool-v2.6 User Guide>` for a burn.The purpose is to familiarize yourself with the burn operation and prepare for the next functional verification.
...
1. First of all, it is necessary for hardware engineers to understand the introduction and basic principles of our development board floor. See :doc:`《Base Plate Introduction》 <./MYZR-IMX6-MB200 Hardware Introduction>` 。
...
3. If some interfaces and functions need to be changed, please refer to the **Pin definition & detailed function description** in  :doc:`《MYZR-IMX6-CB200 Hardware Introduction》 <./MYZR-IMX6-CB200 Hardware Introduction>` .Refer to "1.1 _nxp-document-> reference-manual" in the network disk for more details.
