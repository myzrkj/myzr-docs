...
2. 2. Connect the development board and computer with a serial port line, refer to :doc:`《Terminal Software Reference Manual》 </docs/COMMON/Xshell.RM Reference Manual >` In **connection to session** Open serial session.
