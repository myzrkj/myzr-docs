...
+=========+========+==========+======================================================+
| 1       | D3     | I/O      | General-purpose IO, corresponds to IC D3 (Pin32)     |
+---------+--------+----------+------------------------------------------------------+
| 2       | D7     | I/O      | General-purpose IO, corresponds to IC D7 (Pin2)      |
+---------+--------+----------+------------------------------------------------------+
| 3       | C0     | I/O      | General-purpose IO, corresponds to IC C0 (Pin20)     |
+---------+--------+----------+------------------------------------------------------+
| 4       | SWS    | I/O      | Programming pin, corresponds to IC SWS (Pin5)        |
+---------+--------+----------+------------------------------------------------------+
| 5       | B6     | I        | ADC pin, corresponds to IC B6 (Pin16)                |
+---------+--------+----------+------------------------------------------------------+
| 6       | A0     | I/O      | General-purpose IO, corresponds to IC A0 (Pin3)      |
+---------+--------+----------+------------------------------------------------------+
| 7       | A1     | I/O      | General-purpose IO, corresponds to IC A1 (Pin4)      |
+---------+--------+----------+------------------------------------------------------+
| 8       | C2     | I/O      | Hardware PWM supported, corresponds to IC C2 (Pin22) |
+---------+--------+----------+------------------------------------------------------+
| 9       | C3     | I/O      | Hardware PWM supported, corresponds to IC C3 (Pin23) |
+---------+--------+----------+------------------------------------------------------+
| 10      | D2     | I/O      | Hardware PWM supported, corresponds to IC D2 (Pin31) |
+---------+--------+----------+------------------------------------------------------+
| 11      | B4     | I/O      | Hardware PWM supported, corresponds to IC B4 (Pin14) |
+---------+--------+----------+------------------------------------------------------+
| 12      | B5     | I/O      | Hardware PWM supported, corresponds to IC B5 (Pin15) |
+---------+--------+----------+------------------------------------------------------+
| 13      | GND    | P        | Power ground pin                                     |
+---------+--------+----------+------------------------------------------------------+
| 14      | VCC    | P        | Power supply pin (3.3V)                              |
+---------+--------+----------+------------------------------------------------------+
| 15      | B1     | I/O      | UART_TXD, corresponds to IC B1 (Pin6)                |
+---------+--------+----------+------------------------------------------------------+
| 16      | B7     | I/O      | UART_RXD, corresponds to IC B7 (Pin17)               |
+---------+--------+----------+------------------------------------------------------+
| 17      | C4     | I/O      | ADC pin, corresponds to IC C4 (Pin24)                |
+---------+--------+----------+------------------------------------------------------+
| 18      | RST    | I/O      | Reset pin, active low                                |
+---------+--------+----------+------------------------------------------------------+
| 19      | C1     | I/O      | General-purpose IO, corresponds to IC C1 (Pin21)     |
+---------+--------+----------+------------------------------------------------------+
| 20      | D4     | I/O      | General-purpose IO, corresponds to IC D4 (Pin1)      |
+---------+--------+----------+------------------------------------------------------+
