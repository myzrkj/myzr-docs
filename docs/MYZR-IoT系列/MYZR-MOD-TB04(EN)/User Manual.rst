...
| 3      | NC   | Not Connected                                                            |
+--------+------+--------------------------------------------------------------------------+
| 4      | C4   | PWM2 Output / UART_CTS / PWM0 Inverted Output / SAR ADC Input / GPIO PC4 |
+--------+------+--------------------------------------------------------------------------+
| 5      | C1   | I2C Serial Clock / PWM1 Inverted Output / PWM0 Output / GPIO PC1         |
+--------+------+--------------------------------------------------------------------------+
| 6      | C0   | I2C Serial Data / PWM4 Inverted Output / UART_RTS / GPIO PC0             |
+--------+------+--------------------------------------------------------------------------+
| 7      | B7   | SPI Data Out / UART_RX / SAR ADC Input / GPIO PB7                        |
+--------+------+--------------------------------------------------------------------------+
| 8      | B6   | SPI Data In (I2C_SDA) / UART_RTS / SAR ADC Input / GPIO PB6              |
+--------+------+--------------------------------------------------------------------------+
...
| 12     | GND  | Ground                                                                   |
+--------+------+--------------------------------------------------------------------------+
| 13     | RXD  | PWM0 Inverted Output / UART_RX / GPIO PA0                                |
+--------+------+--------------------------------------------------------------------------+
